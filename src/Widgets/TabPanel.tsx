          ...
          tabs.map((_, i) => (
            <li key={i} className="inline-block">
              <button
                ...
                className={`${i === currentIndex ? "border-b-white" : "  border-gray-200 border-b-gray-800 hover:bg-gray-100 hover:border-gray-600"} -mb-px active:bg-gray-200 transition bg-white cursor-pointer border-1 rounded-t px-4 mx-1 font-bold`}
              >
              {labels[i] || `Tab ${i+1}`}
              </button>
            </li>
